namespace LibraryManageSystem
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "产品名称：图书馆管理系统";
            ...
            this.labelCopyright.Text = "版权：c#4组版权所有";
            ...
            this.labelCompanyName.Text = "小组成员：赵志鹏，王鹏，李一帆，郭森";
            ...
            this.textBoxDescription.Text = "本程序使用到的开放技术及平台：阿里云短信推送，阿里云邮件推送，OSS对象存储，百度AI，阿里云ECS用作远程SQL数据库,腾讯云开发者平台，坚果云同步，git";
            // 
            // okButton
            // 
